...
if (!empty($_POST)) {
    ...
    $image = $_POST['image'];
    $image2 = $_POST['image2'];
    $req = "UPDATE products SET name = '$nom', description='$descritpion', price='$prix', date='$date', category='$categorie', image='$image', image2='$image2' WHERE id =". $id;
...
$req = "SELECT * FROM products WHERE id = " . $_GET['id'];
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Gestion des produits</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <table>
                                <form action="#" method="post">
                                    ...
                                    <tr>
                                        <td>id :</td>
                                        <td><input type="text" name="id" value="<?php echo $produit['id']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>nom produit :</td>
                                        <td><input type="text" name="name" value="<?php echo $produit['name']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>déscription :</td>
                                        <td><input type="text" name="description" value="<?php echo $produit['description']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>prix produit :</td>
                                        <td><input type="text" name="price" value="<?php echo $produit['price']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>date :</td>
                                        <td><input type="text" name="date" value="<?php echo $produit['date']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>catégorie :</td>
                                        <td><input type="text" name="category" value="<?php echo $produit['category']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>image 1 :</td>
                                        <td><input type="file" name="image" value="<?php echo $produit['image']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>image 2 :</td>
                                        <td><input type="file" name="image2" value="<?php echo $produit['image2']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
