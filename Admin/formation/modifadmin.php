...
if (!empty($_POST)) {
    ...
    $req = "UPDATE admins SET last_name = '$nom', first_name='$prenom', email='$email', password='$password' WHERE id =". $id;
...
$req = "SELECT * FROM admins WHERE id = " . $_GET['id'];
                        ...
                        <div class="widget-body">
                            <table>
                                <form action="#" method="post">
                                    ...
                                    <tr>
                                        <td>id :</td>
                                        <td><input type="text" name="id" value="<?php echo $admin['id']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>nom :</td>
                                    ...
                                    <tr>
                                        <td>email :</td>
                                        <td><input type="text" name="price" value="<?php echo $admin['email']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>password :</td>
                                        <td><input type="text" name="date" value="<?php echo $admin['password']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
