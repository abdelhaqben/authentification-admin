            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Listes des Administrateurs</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Gestion des Administrateur</h4>
                            <span class="tools">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php while ($p = mysqli_fetch_assoc($res))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo "/flat-login-form/Admin/formation/modifadmin.php?id=" . $p['id'];?>">Modifier</a> <br>
                                            <a href="<?php echo "/flat-login-form/Admin/formation/suppradmin.php?id=" . $p['id'];?>">Supprimer</a>
                                        </td>
                                    </tr>
                                <?php   } ?>
                                </tbody>
