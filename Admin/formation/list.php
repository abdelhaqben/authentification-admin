            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Listes des produits</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
...
<?php while ($p = mysqli_fetch_assoc($res))
{
    ?>
                                <tr>
                                    ...
                                    <td><?php echo  $p['image2']; ?> </td>
                                    <td>
                                        <a href="<?php echo "/flat-login-form/Admin/formation/modif.php?id=" . $p['id'];?>">Modifier</a> <br>
                                        <a href="<?php echo "/flat-login-form/Admin/formation/suppr.php?id=" . $p['id'];?>">Supprimer</a>
                                    </td>
                                </tr>
                                <?php   } ?>
                                </tbody>
...
<p style="color:red">  </p>
<a href="http://localhost/flat-login-form/Admin/formation/form.php">Ajouter Un Produit</a>
