            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Ajouter un Produit</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="ajout.php" method="post">
                                ...
                                <tr><td>nom produit    :</td><td><input type="text" name="name"></td></tr>
                                <tr><td>déscription    :</td><td><input type="text" name="description"></td></tr>
                                <tr><td>prix produit   :</td><td><input type="text" name="price"></td></tr>
                                <tr><td>date           :</td><td><input type="text" name="date"></td></tr>
                                <tr><td>catégorie      :</td><td><input type="text" name="category"></td></tr>
                                <tr><td>image 1        :</td><td><input type="file" name="image"></td></tr>
